...
public class NetworkBuletooth extends AsyncTask<String, Integer, String> {
    ...
    // 서비스도메인
    String urlAddr = "http://133.130.99.167/mimamo/public/";
    ...
    public NetworkBuletooth(Context context, String uri, String httpMethod, JSONObject jsonObject) {
    ...
    public NetworkBuletooth(Context context, String uri, String httpMethod) {
